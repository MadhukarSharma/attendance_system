      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            @endif
            <form class="form-horizontal" action="{{route('contact.send_mail')}}" method="post">
            {{csrf_field()}}
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" name="email_from" placeholder="Your Email">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" name="email_to" value="{{$contact->email}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Message</label>
                      ...
                      <div class="col-sm-10">
                        <form>
                         <textarea  id="editor1" name="body_message" rows="10" cols="80">
                          Give Message ...
                         </textarea>
                        </form>
                      </div>
